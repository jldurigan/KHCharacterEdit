...
namespace KHCharacterEdit.Controllers
{
    public class AbilityController : Controller
    {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            {
                return Content("<script language='javascript' type='text/javascript'>alert('You cannot delete an ability already equipped to a character, accessory or weapon!');</script>");
            }
            return RedirectToAction("Index");
        }
